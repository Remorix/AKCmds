...
Aligned with AKCmds-345.60.106 (Darwin 22) for macOS implementations, iOS supportings are basically rewrites since there's no AppKit on iOS, so no guarantees on exact same behaviors.
